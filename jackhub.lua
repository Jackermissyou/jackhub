...
local Window = Fluent:CreateWindow({
    Title = "Jack Hub",
    SubTitle = "make by Jacl,Vỹ,I am so Funny",
    TabWidth = 160,
...
ImageButton.Image = "rbxassetid://15935059060"
...
local Mastery = Tabs.Main:AddSection("Mastery Farm")
    local DropdownMastery = Tabs.Main:AddDropdown("DropdownMastery", {
        Title = "Mastery Mode",
        Values = {"Level","Near Mobs","Bone","Kata"},
        Multi = false,
        Default = 1,
    })
...
local Turnonracev4 = Tabs.Setting:AddToggle("ToggleTuronracev4", {Title = " Enable racev4", Default = true })
ToggleBringMob:OnChanged(function(Value)
    _G.Turnonracev4 = Value
end)
Options.ToggleTuronracev4:SetValue(true)
spawn(function()
    while wait() do
        pcall(function()
            if Turnonracev4 then
...
local Turnonracev3 = Tabs.Setting:AddToggle("ToggleTuronracev3", {Title = " Enable racev3", Default = true })
ToggleBringMob:OnChanged(function(Value)
    _G.Turnonracev3 = Value
end)
Options.ToggleTuronracev3:SetValue(true)
spawn(function()
    while wait() do
        pcall(function()
            if Turnonracev3 then
                game:GetService("VirtualInputManager"):SendKeyEvent(true, "T", false, game)
                wait(0.1)
                game:GetService("VirtualInputManager"):SendKeyEvent(false, "T", false, game)
            end
