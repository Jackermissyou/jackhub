...
getgenv().ToTargets = function(p)
    ...
    local Window = OrionLib:MakeWindow({Name = "Anbatukam Hub | Blox Fruits", HidePremium = false, IntroText = "Anbatukam Hub | Community", Icon = "15034250264"})
...
SettingTab:AddSlider({
	Name = "Set Topos X ( Work For Some Toggle )",
	Min = 0,
	Max = 30,
	Default = 10,
...
SettingTab:AddSlider({
	Name = "Set Topos Y ( Work For Some Toggle )",
	Min = 0,
	Max = 30,
	Default = 10,
	Color = Color3.fromRGB(255,255,255),
...
SettingTab:AddSlider({
	Name = "Set Topos Z ( Work For Some Toggle )",
	Min = 0,
	Max = 30,
	Default = 10,
	Color = Color3.fromRGB(255,255,255),
...
task.spawn(function()
	while task.wait() do
		pcall(function()
			if MakoriGayMag or _G.BringMonster then
				for i,v in pairs(game.Workspace.Enemies:GetChildren()) do
