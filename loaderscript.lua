...
local Window = OrionLib:MakeWindow({Name = "Jack Hub Auto Bounty", HidePremium = false, SaveConfig = true, ConfigFolder = "Jack Hub Auto Bounty Config"})
--- Counter
...
game:GetService("CoreGui").RobloxPromptGui.promptOverlay.ChildAdded:Connect(function(child)
    if not hopserver and child.Name == 'ErrorPrompt' and child:FindFirstChild('MessageArea') and child.MessageArea:FindFirstChild("ErrorFrame") then
        ...
        Notify("Jack Hub Auto Bounty | Rejoin from kicked!")
    end
end)
--- Webhook
function wSend(main)
        ...
        ["embeds"] = {
            {
                ...
                ["fields"] = {
                    {
                        ["name"] = "Test Webhook",
                        ["value"] = "Jack was here :eyes:",
                        ["inline"] = false,
                    },
                },
                ["thumbnail"] = {
                    ["url"] = "https://cdn.discordapp.com/emojis/1143533955585417236.gif?size=48&name=emoji_18%7E1&quality=lossless",
                },
                ["footer"] = {
                    ["text"] = "Jack Hub - discord.gg/C83Fdy2Svg",
                },
            ...
            ["embeds"] = {
                {
                    ...
                    ["footer"] = {
                        ["text"] = "Jack Hub - Jack Hub - discord.gg/C83Fdy2Svg",
                    },
                    ["timestamp"] = os.date("!%Y-%m-%dT%H:%M:%SZ"),
                }
            }
