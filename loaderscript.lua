...
if game.CoreGui:WaitForChild("RobloxGui"):WaitForChild("Modules"):FindFirstChild("Jack Hub Kaitun") then
    local Main = game.CoreGui:WaitForChild("RobloxGui"):WaitForChild("Modules"):FindFirstChild("Jack Hub Kaitun").Main
...
function library:Createlibrary()
    ...
    LogoBackground.Image = "rbxassetid://15935059060"
            ...
            while wait() do
                ...
                for _, Clone_1 in pairs(game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitInventory.Container.Stored.ScrollingFrame:GetChildren()) do
                    if Clone_1:IsA("Frame") then
                        ...
                        print(Clone_Fruit)
                        if not game:GetService("CoreGui"):WaitForChild("RobloxGui"):WaitForChild("Modules"):WaitForChild("Jack Hub Kaitun").Main.PlayerUIMain2.ScrollingFrame:FindFirstChild(Clone_Fruit.Name) then
                            Clone_Fruit.Parent = game:GetService("CoreGui"):WaitForChild("RobloxGui"):WaitForChild("Modules"):WaitForChild("Jack Hub Kaitun").Main.PlayerUIMain2.ScrollingFrame
