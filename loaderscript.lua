...
print("i love khánh băng")
print("i love vỹ")
print("load succes")
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Yellow> Loading <Jack Hub> <Color=/>"):Display()
Notification.new("<Color=Red> Made by Jacker<Color=/>"):Display()
Notification.new("<Color=Blue> Discord:https://discord.gg/RE3aBJHdMa <Color=/>"):Display()
-------------------// I Write... \\----------------------------------------
...
I:AddLabel("Owner : Jack")

I:AddLabel("Dev : Jacker, I am so sad,Vỹ")
        ...
        pcall(function()
            if MasMelee then
                ...
                elseif game.Players.LocalPlayer.Character:FindFirstChild("God Human") and (game.Players.LocalPlayer.Character:FindFirstChild("God Human")).Level.Value >= 600 or game.Players.LocalPlayer.Backpack:FindFirstChild("God Human") and (game.Players.LocalPlayer.Backpack:FindFirstChild("God Human")).Level.Value >= 600 then
                    ...
                    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
                elseif game.Players.LocalPlayer.Character:FindFirstChild("Sanguine Art") and (game.Players.LocalPlayer.Character:FindFirstChild("Sanguine Art")).Level.Value >= 600 or game.Players.LocalPlayer.Backpack:FindFirstChild("Sanguine Art") and (game.Players.LocalPlayer.Backpack:FindFirstChild("Sanguine Art")).Level.Value >= 600 then
                end
            end
        end)
    end
